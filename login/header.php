<head>
  ...
  <?php 
  date_default_timezone_set("Asia/Manila"); //Sets default timezone
  
  ob_start();
  //Checks if 'page' parameter is set in the URL query string .If yes,it replaces underscores with spaces using str_replace
