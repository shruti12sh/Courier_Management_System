...
<script>
	$('#manage-branch').submit(function(e){
      ...
      //data attribute specifies the form data to be sent in the request . Here we are creating a FormData object containing the form data 
          ...
          //After 2 seconds page is redirected to index.php
					setTimeout(function(){
