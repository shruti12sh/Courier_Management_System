		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					?>
					<!-- ucword function is to capitalize the first char of each string -->
					<tr>
...
<script>
	//This line ensures that code should only be executed when DOM is fully loaded
	$(document).ready(function(){
		//Initialize the datatable plugin , it enhances the functionality and appearance of HTML table
		$('#list').dataTable()
